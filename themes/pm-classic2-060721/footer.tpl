...
<footer>
  <div class="center">
    <hr>
    <div class="container">
      <p class="textfooter">{$title} {$l_powered} {$l_pamplemoussecms} {$l_and} {$l_smarty} <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="#DA4453" class="bi bi-heart-fill" viewBox="0 0 16 16">
