...
if(isset($_SESSION['id'])){
    ...
    if(!empty($_POST['article_title']) AND !empty($_POST['article_section'])) {
       ...
       $ins = $db->prepare('INSERT INTO articles (title, descr, img, section, datep, id_author, visible) VALUES (?, ?, ?, ?, NOW(), ?, ?)');
       $ins->execute(array($article_title, $article_descr, $article_img, $article_section, $_SESSION['id'], 1));
