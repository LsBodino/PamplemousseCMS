...
<body>
  <div class="container">
    {if !isset($smarty.session.id)}
      ...
      <p>{$l_notregistered2} {$title}. {$l_notregistered3}! <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-emoji-laughing" viewBox="0 0 16 16">
