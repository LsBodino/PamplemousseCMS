      ...
      {else}
        ...
        <div class="card mb-3" style="max-width: 540px;">
          <div class="row g-0">
            ...
            <div class="col-md-8">
              <div class="card-body">
                <h5 class="card-title">{$ap.title} <button type="button" class="btn btn-outline-light" id="pin"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="#DA4453" class="bi bi-pin-angle-fill" viewBox="0 0 16 16">
                <path d="M9.828.722a.5.5 0 0 1 .354.146l4.95 4.95a.5.5 0 0 1 0 .707c-.48.48-1.072.588-1.503.588-.177 0-.335-.018-.46-.039l-3.134 3.134a5.927 5.927 0 0 1 .16 1.013c.046.702-.032 1.687-.72 2.375a.5.5 0 0 1-.707 0l-2.829-2.828-3.182 3.182c-.195.195-1.219.902-1.414.707-.195-.195.512-1.22.707-1.414l3.182-3.182-2.828-2.829a.5.5 0 0 1 0-.707c.688-.688 1.673-.767 2.375-.72a5.922 5.922 0 0 1 1.013.16l3.134-3.133a2.772 2.772 0 0 1-.04-.461c0-.43.108-1.022.589-1.503a.5.5 0 0 1 .353-.146z"/>
                </svg></button></h5>
                <p class="card-text">{$ap.descr}</p>
                <p class="card-text"><small class="text-muted">{$l_published} {$ap.datep|date_format:"%d/%m/%y"} {$l_by} {$ap.author} {$l_in} {$ap.category}</small></p>
          ...
          <div class="row g-0">
            ...
            <div class="col-md-8">
              <div class="card-body">
                ...
                <p class="card-text"><small class="text-muted">{$l_published} {$anp.datep|date_format:"%d/%m/%y"} {$l_by} {$anp.author} {$l_in} {$anp.category}</small></p>
